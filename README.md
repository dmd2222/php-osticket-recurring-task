# php-osticket-recurring-task
Add a simple possibility to use recurring tasks over the osticket API.



# Features
- Creats a task every x seconds.


# Installation
- Copy the code in your ftp folder. (Ready to use. :) )
    - Script as a new folder 
    - replace class.api.php 
- change options in DoIntervallAufgaben.php and config.php the beginning of the main file.

  # Using
  After the first call you can edit db.txt by editor
